        ...
        <div>
            ...
            <div
                ...
                <div className='overlay justify-center items-center absolute w-full h-full left-0 top-0 bg-[#181818] bg-opacity-0 hidden group-hover:flex group-hover:bg-opacity-80 transition-all duration-300'>
                    <Link href={gitUrl} className='mr-4 flex justify-center items-center w-14 h-14 border-2 relative rounded-full border-[#adb7be] hover:border-white group/link text-center'>
                        <CodeBracketIcon className='w-10 h-10 text-[#adb7be] cursor-pointer group-hover/link:text-white' />
                    </Link>
                    <Link href={previewUrl} className='flex justify-center items-center w-14 h-14 border-2 relative rounded-full border-[#adb7be] hover:border-white group/link text-center'>
